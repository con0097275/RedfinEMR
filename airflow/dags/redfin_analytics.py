...
job_flow_overrides = {
    ...
    "LogUri": "s3://redfin-data-project-yml-vannguyen/emr-logs-yml/",
    ...
    "Instances": {
        ...
        "Ec2SubnetId": "subnet-0d94fb4e17e14978c",
...
SPARK_STEPS_EXTRACTION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                "s3://redfin-data-project-yml-vannguyen/scripts/ingest.sh",
            ],
        },
    },
   ]
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit",
            "s3://redfin-data-project-yml-vannguyen/scripts/transform_redfin_data.py",
            ],
        },
    },
   ]
